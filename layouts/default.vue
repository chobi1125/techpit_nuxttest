   ...
   <header class="w-64 h-64">
     <div class="w-64 mt-24 ml-2 relative md:fixed">
       <div class="flex">
         ...
         <div>
           <h1 class="font-bold">Sato Masaru</h1>
           <p class="text-xs text-justify">I am a self-taught Programmer in Tokyo.</p>
         </div>
       </div>
...
.photo {
  min-width: 4rem; 
  min-height: 4rem;
  background-image: url('https://chobimusic.com/wp-content/uploads/2020/02/about-me-square.jpg');
}
button:focus {
  outline: none;
}
